...
+ Not all articles are published in WoS-listed journals. On the contrary, there is a rather large difference between academic fields. We are aware of this difference….
...
All data are available, but we have not performed the matching bewtween data sources.
...
Pilot data were also used to make sure that the coverage of funding information was sufficient (need a number?) in Crossref.
