---
title           : "Behaviour in open access publication preregistration"
...
How does a requirement from the fundig agency to publish articles open access affect the publication behaviour?
...
We will collect bibliometric information from web of science via their API. 
We will collect funding information from crossref via their API.
We will collect open access status of published articles from oadoi via the r package roadoi (insert reference).
...
Swedish affiliation is defined by XXXXXXXXXXXXXX.
The link between articles and funding information in crossref is the article doi.
The funding information from Crossref is free text. We will identify relevant funders with regular expression. 
...
Vetenskapsrådet - The Swedish research agency
Forte - ....
Formas - .....
...
All data is publicaly available. 
...
We will conduct a multilevel analysis. The dependent variabe will be open access status of the articles. The independent variables will have different levels, ..... 
